...
if(!function_exists('license_manage_menu'))
{
	...
	{
		add_submenu_page(  'edit.php?post_type=event_listing', __( 'License', 'wp-event-manager-sliders' ),  __( 'License', 'wp-event-manager-sliders' ) , 'manage_options', 'license','wpem_manage_license' );
	}
}
...
if(!function_exists('wpem_manage_license'))
{
	function wpem_manage_license() 
	{
		...
		<div class="wrap wpem-updater-licence-wrap">
			<h2><?php _e('License', 'wp-event-manager-sliders'); ?></h2>
			...
			<div class="notice notice-info inline"><p><?php _e('Lost your license key?', 'wp-event-manager-sliders'); ?> <a target="_blank" href="//wp-eventmanager.com/lost-license-key/"><?php _e('Retrieve it here', 'wp-event-manager-sliders'); ?></a>.</p></div>
		</div>
